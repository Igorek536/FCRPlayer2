...
public class SpectrumPanel extends JPanel {
    ...
    private final int BANDS = 28;
    private int specmode = 3, specpos = 0; //Spectrum mode (and marker pos for 2nd mode)

    private ByteBuffer buffer = null;
    private BufferedImage image = null;

    private final int color1 = new Color(0, 255, 145).getRGB();
    private final int color2 = new Color(197, 103, 255).getRGB();
